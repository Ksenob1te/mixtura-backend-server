...
from src.domain.models.member.request import MemberRestrictionCreateRequest, MemberUpdateRequest, MigrationRequest, VirtualMemberCreateRequest
...
class MemberController(Controller):
    ...
    def add_restriction(self, server_id: UUID, member_id: UUID, body: MemberRestrictionCreateRequest): # TODO : User id depend
        # TODO : Issuer Member get depend
        pass
        
    @delete("/{member_id}/restrictions/{member_restriction_id}", response_model=StatusResponse)
    def remove_restriction(self, server_id: UUID, member_id: UUID, member_restriction_id: UUID): # TODO : User id depend
        # TODO : Issuer Member get depend
        pass