...
class TestGameRoleSetRepository:
    ...
    async def test_delete_role_set(self, async_session):
        repo = GameRoleSetRepository(async_session)
    ...
    async def test_get_global_role_sets(self, async_session):
        repo = GameRoleSetRepository(async_session)
    ...
    async def test_copy_global_role_set(self, async_session):
        repo = GameRoleSetRepository(async_session)
